<%-- 
    Document   : Home
    Created on : 16-May-2024, 23:37:25
    Author     : User
--%>
...
<html lang="pt-br">
    <head>
        ...
        <title>Sistema de Gestão de Estudantes - Tema Bootstrap</title>
        <!-- Ícone-->
            ...
            <div class="container px-4 px-lg-5 h-100">
                <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-8 align-self-end">
                        <h1 class="text-white font-weight-bold">Sistema Educacional Inteligente</h1>
                    ...
                    <div class="col-lg-8 align-self-baseline">
                        ...
                        <a class="btn btn-primary btn-xl me-2" href="#alunos">Alunos</a>
                        <a class="btn btn-success btn-xl" href="#administradores">Administradores</a>
                    </div>
                </div>
            </div>
        </header>
