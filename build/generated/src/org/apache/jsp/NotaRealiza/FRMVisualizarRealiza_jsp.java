...
public final class FRMVisualizarRealiza_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    <title>Detalhes da Realização</title>\n");
      ...
      out.write("    <link rel=\"stylesheet\" href=\"../css/Realizacao.css\">\n");
      out.write("</head>\n");
      out.write("<body>\n");
      out.write("    <div class=\"container\">\n");
      out.write("        <div class=\"text\">\n");
      out.write("            Detalhes da Realização\n");
      out.write("        </div>\n");
      out.write("        \n");
      out.write("        <div class=\"row mt-4\">\n");
      out.write("            <div class=\"col-md-6\">\n");
      out.write("                <div class=\"form-group\">\n");
      out.write("                    <label for=\"idEstudante\">ID do Estudante:</label>\n");
      out.write("                    <!-- Use scriptlet para acessar os parâmetros passados na URL -->\n");
      out.write("                    <input type=\"text\" class=\"form-control\" id=\"idEstudante\" value=\"");
      out.print( request.getParameter("idEstudante") );
      out.write("\" readonly>\n");
      out.write("                </div>\n");
      out.write("                <div class=\"form-group\">\n");
      out.write("                    <label for=\"idAvaliacao\">ID da Avaliação:</label>\n");
      out.write("                    <!-- Use scriptlet para acessar os parâmetros passados na URL -->\n");
      out.write("                    <input type=\"text\" class=\"form-control\" id=\"idAvaliacao\" value=\"");
      out.print( request.getParameter("idAvaliacao") );
      out.write("\" readonly>\n");
      out.write("                </div>\n");
      out.write("                <div class=\"form-group\">\n");
      out.write("                    <label for=\"nota\">Nota:</label>\n");
      out.write("                    <!-- Use scriptlet para acessar os parâmetros passados na URL -->\n");
      out.write("                    <input type=\"text\" class=\"form-control\" id=\"nota\" value=\"");
      out.print( request.getParameter("nota") );
      out.write("\" readonly>\n");
      out.write("                </div>\n");
      out.write("            </div>\n");
      out.write("        </div>\n");
