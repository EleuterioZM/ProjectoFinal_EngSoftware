...
public final class FRMExclusaoAvaliacao_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    <title>Exclusão de Avaliação</title>\n");
      out.write("\n");
      out.write("    <style>\n");
      out.write("        body {\n");
      ...
      out.write("            background-image: url('../img/avaliacao.jpg'); /* Caminho da sua imagem de fundo */\n");
      ...
      out.write("            <h2>Exclusão de Avaliação</h2>\n");
      out.write("            <p>Deseja realmente excluir a avaliação \"");
      out.print( request.getParameter("nome") );
      out.write("\"?</p>\n");
      out.write("            <form id=\"deleteForm\" action=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${pageContext.request.contextPath}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/AvaliacaoServlet?action=delete\" method=\"POST\">\n");
      out.write("                <input type=\"hidden\" id=\"avaliacaoId\" name=\"id\" value=\"");
      out.print( request.getParameter("id") );
      out.write("\">\n");
      out.write("                <input type=\"hidden\" id=\"avaliacaoNome\" name=\"nome\" value=\"");
      out.print( request.getParameter("nome") );
      out.write("\">\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${pageContext.request.contextPath}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/Avaliacao/FRMListarAvaliacoes.jsp\"; // Redirecionar de volta para a página de listagem\n");
      out.write("        }\n");
      out.write("    </script>\n");
      out.write("\n");
      out.write("    <script>\n");
      out.write("        function logFormData() {\n");
      out.write("            var id = document.getElementById(\"avaliacaoId\").value;\n");
      out.write("            var nome = document.getElementById(\"avaliacaoNome\").value;\n");
      out.write("            \n");
      out.write("            console.log(\"ID da avaliação: \", id);\n");
      out.write("            console.log(\"Nome da avaliação: \", nome);\n");
      out.write("\n");
